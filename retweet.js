...
var config = {
    me: 'LOLvote_bot', // The authorized account with a list to retweet.
    myList: 'test1', // The list we want to retweet.
    regexFilter: '@LOLvote_bot', // Accept only tweets matching this regex pattern.
...
function onTweet(tweet) {
	console.log("A tweet was detected");
    // Reject the tweet if:
    ...
    if (config.regexReject !== '' && regexReject.test(tweet.text)) {
    	console.log("A tweet was rejected");
        return;
    }
